...
function ContextMenuLabel({
  ...
  return (
    <div
      ...
      data-inset={inset}
      className={cn(
        "text-muted-foreground px-2 py-1.5 text-xs font-semibold select-none data-inset:pl-7",
        className,
      )}
      {...props}
    />
